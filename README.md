...
《绝地潜兵 2》鼠标长按充能提示工具，基于 [nine-sec/HD2-ChargeBar](https://github.com/nine-sec/HD2-ChargeBar) 改进。当前版本：**1.1.0**，适用于 Windows x64。
...
- 默认 F1 切换模式、F2 退出，仅游戏前台生效；可分别开关、修改快捷键。
- 自动记住显示模式和热键设置。关闭设置窗口后继续驻留托盘。
- 保留原有 3 秒充能计时，2 秒变黄、2.5 秒变红。
